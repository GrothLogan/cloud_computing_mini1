...
public class access_log_hadoop1 {
    ...
    public void map(Object key, Text value, Context context
      ...
      Matcher matcher = pattern.matcher(value2);
        if(matcher.find())
        {
          ...
          if (request.contains("/images/smilies/")){
            word.set("/images/smilies/");
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "access_log_hadoop1");
    job.setJarByClass(access_log_hadoop1.class);

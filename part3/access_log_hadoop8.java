...
public class access_log_hadoop8 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "access_log_hadoop8");
    job.setJarByClass(access_log_hadoop8.class);

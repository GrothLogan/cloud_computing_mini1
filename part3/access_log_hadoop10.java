...
public class access_log_hadoop10 {
    ...
    public void map(Object key, Text value, Context context
      ...
      Matcher matcher = pattern.matcher(value2);
        if(matcher.find())
        {
          ...
          if(timestamp.contains("16/Jan/2022"))
          {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "access_log_hadoop10");
    job.setJarByClass(access_log_hadoop10.class);
